...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerGridItemDecoration(Context context,int height) {
        this.mDividerHeight = height;
        this.mDividerWidth = height;
        mDivider= ContextCompat.getDrawable(context, R.color.background_f2);
    }
    public DividerGridItemDecoration(Context context,int height,int drawableId) {
        this.mDividerHeight = height;
        this.mDividerWidth = height;
