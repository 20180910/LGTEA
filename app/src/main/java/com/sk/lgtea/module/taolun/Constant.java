package com.sk.lgtea.module.taolun;
...
public class Constant {
    ...
    public static class IParam{
        ...
        public static final String discussion_forum_id="discussion_forum_id";//讨论区帖子ID
        public static final String comments_id="comments_id";//讨论区帖子ID
