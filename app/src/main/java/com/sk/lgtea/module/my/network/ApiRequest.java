...
public class ApiRequest extends BaseApiRequest {
    ...
    public static void getEditPhone(Map map, MyCallBack callBack) {
        ...
        getGeneralClient(IRequest.class).getEditPhone(map).enqueue(callBack);
    }
    ...
    public static void getEditEmail(Map map, MyCallBack callBack) {
        ...
        getGeneralClient(IRequest.class).getEditEmail(map).enqueue(callBack);
    }
    ...
    public static void getSubmitFeedback(Map map, MyCallBack callBack) {
        ...
        getGeneralClient(IRequest.class).getSubmitFeedback(map).enqueue(callBack);
    }
    ...
    //修改老师简介
    public static void getSetIndividualitySignature(Map map,  MyCallBack callBack) {
        if (notNetWork(callBack.getContext())) { callBack.onFailure(null, new NoNetworkException(Config.noNetWork)); return; }
        getGeneralClient(IRequest.class).getSetIndividualitySignature(map).enqueue(callBack);
    }
