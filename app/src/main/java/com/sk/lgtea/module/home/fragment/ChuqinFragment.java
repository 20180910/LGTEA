...
public class ChuqinFragment extends BaseFragment {
    ...
    public static ChuqinFragment newInstance(String Id,String Time) {
        Bundle args = new Bundle();
        ChuqinFragment fragment = new ChuqinFragment();
    ...
    protected void getData(int page, boolean isLoad) {
        ...
        ApiRequest.getAttendanceStatisticDetail(map, new MyCallBack<KaoqinjilvObj>(mContext,pcfl,pl_load) {
            ...
            public void onSuccess(KaoqinjilvObj obj) {
                RxBus.getInstance().post(new ChuqinEvent(obj.getTotal_number()));
                if(isLoad){
                    pageNum++;
